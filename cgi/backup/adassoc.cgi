...
$wsdl_url = "http://www.google.com/api/adsense/v2/AccountService?WSDL";
...
my $synServiceData = $accountService->associateExistingAccount($loginEmail,$postalCode,$phone,@headers);
...
print "<HTML><BODY>Success! Your AdSense account has been successfully associated with this site.  <b>An email allowing you to confirm this association has been sent to  <i>$uemail</i></b>.  To receive advertising revenue for your writing, please <UL><LI><b>Follow the instructions in the email you receive</b> <LI>Make sure you are logged in when submitting articles <LI> Follow good writing practices: for reporting, be detailed and accurate and site your sources.  Make sure you are submitting to an appropriate category, and check the 'Feature' box if you would like your article considered for a site-wide feature. </UL>  <p><A HREF='http://bTucson.com/'>Return to bTucson.com</A> * <A HREF='http://bTucson.com/users/$userlogin'>View My Articles</A> <p><small>Technical note:  your account on this site now has an associated " .

  $synServiceType . " syndication service with id " . $synServiceId . "</small></BODY></HTML>\n";

#print "<HTML><BODY>Result of association: your account has an associated ".
...
if ($existing_google_client_id) {
	...
	print "<p><small>Result of association: your account has an associated ".$synServiceType . " syndication service with id " . $synServiceId . "</small>";
}
print '<p><hr><A HREF="http://bTucson.com/">back to bTucson.com</A> &nbsp;&nbsp; <A HREF="/adsignup.php">back to the Associate Account page</A>';
print "</BODY></HTML>\n";
